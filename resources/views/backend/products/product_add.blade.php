        ...
        <div class="form-group">
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" id="product_eng" name="product_eng" class="form-control" required="">
                        @error('product_eng')
                            <span class="text-danger" >{{ $message }}</span>
                        @enderror
                    </div>
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" id="product_ar" name="product_ar" class="form-control" required="">
                        @error('product_ar')
                            <span class="text-danger" >{{ $message }}</span>
                        @enderror
                    </div>
...
<div class="row"> <!-- start 4th row  -->
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text"  name="product_tags_ar" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" />
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text"  name="product_size_en" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" />
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text"  name="product_size_ar" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="add tags" />
...
<div class="row"> <!-- start 5th row  -->
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text"  name="product_colors_en" value="Black,Red,White" data-role="tagsinput" placeholder="add tags" />
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text"  name="product_colors_ar" value="Black,Red,White" data-role="tagsinput" placeholder="add tags" />
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    <h5 for="product_selling_price">Product Selling Price <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text"  name="product_selling_price"  class="form-control" required="" />
...
<div class="row"> <!-- start 6th row  -->
    <div class="col-md-4">
        ...
        <div class="form-group">
            <h5 for="product_discount_price">Product Discount Price <span class="text-danger">*</span></h5>
            <div class="controls">
                <input type="text"  name="product_discount_price"  class="form-control" required="" />
			...
			<div class="col-md-4">
                ...
                <div class="form-group">
                    <h5 for="multi_image">Multi Images <span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="file" name="multi_img[]" class="form-control" multiple="" required id="multiImg" >
                        @error('multi_image')
                            <span class="text-danger" >{{ $message }}</span>
                        @enderror
		...
		<div class="col-md-6">
			<div class="form-group">
				<div class="controls">
					...
					<fieldset>
						<input type="checkbox" id="checkbox_2" name="featured"  value="2">
		...
		<div class="col-md-6">
			<div class="form-group">
				<div class="controls">
					...
					<fieldset>
						<input type="checkbox" id="checkbox_4" name="special_deals" value="2">
