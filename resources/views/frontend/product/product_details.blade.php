	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>{{ $my_product->product_name_en }}</li>
			</ul>
                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">{{ $my_product->product_name_en }}</h1>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
                                            @if ($my_product->discount_price == Null)
                                            <span class="price">${{  $my_product->selling_price }}</span>

                                            @else
                                            <span class="price">${{ $my_product->discount_price }} </span> <span class="price-before-discount">$ {{  $my_product->selling_price }}</span>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text"> {!! $my_product->long_descp_en !!}</p>
									</div>
								</div><!-- /.tab-pane -->
