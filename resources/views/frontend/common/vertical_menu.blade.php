...
@if(session()->get('language') == 'arabic') {{ $subsubcategory->subsubcategory_name_ar }} @else {{ $subsubcategory->subsubcategory_name_en }} @endif</a></li>
...
@endforeach <!-- // End SubSubCategory Foreach -->
          ...
          <!-- /.dropdown-menu --> </li>
@endforeach   {{-- endforeach for category --}}
        <!-- /.menu-item -->
